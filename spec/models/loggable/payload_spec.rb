...
RSpec.describe Loggable::Payload, type: :model do
  describe 'validations' do
    ...
    it 'is valid with valid attributes and a valid activity' do
      ...
      payload = Loggable::Payload.new(owner: owner, attrs: attrs , activity: activity)
    ...
    it 'is invalid without attrs' do
      owner = FactoryBot.create(:user)
      payload = Loggable::Payload.new(owner: owner, activity: activity)
      payload.valid?
    ...
    it 'is invalid without an associated activity' do
      attrs = { key: "value"}.to_json 
      owner = FactoryBot.create(:user)
      payload = Loggable::Payload.new(owner: owner, attrs: attrs)
      payload.valid?
